...
def get_dataset(data_config, test=False):
    # 新增调试打印
    print("data_config.dataset_config 类型:", type(data_config.dataset_config))
    print("data_config.dataset_config 内容:", data_config.dataset_config)
    if test:
    ...
    # runners/utils.py 中 get_dataset 函数
